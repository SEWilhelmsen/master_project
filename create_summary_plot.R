...
# Cardiac remodelling plot
###############################################################################
# Create remodelling plot here:
file.edit("C:/Users/siljeew/Master_project/create_remodelling_plot_for_summary.R")
...
#   scale_color_manual(values = c("Fibrosis" = "darkcyan", "LVW/BW" = "brown")) +
...
##############################################################################
# Create transcription plot here:
file.edit("C:/Users/siljeew/Master_project/create_transcription_plot_for_summary.R")
# 
...
# ###############################################################################
file.edit("C:/Users/siljeew/Master_project/create_signal_plot_for_summary.R")
