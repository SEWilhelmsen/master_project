# Run create violin plot to investigate variance of a gene in the different groups and at different time points (ikke ferdig)
# Silje Wilhelmsen
...
ggsave(file.path(output_dir_plot, paste(genes_of_interest, "_violin_plot.png", sep = "")), plot = violin_plot, width = 8, height = 6)
