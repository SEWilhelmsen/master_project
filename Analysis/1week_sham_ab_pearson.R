...
# mouse_1w_pca_corr <- cor(mouse_1w_pca, method = "pearson")


# Assuming mouse_1w_pca is your Seurat object after running PCA

# Extract PCA embeddings
pca_embeddings_umap <- Embeddings(mouse_1w_umap, reduction = "umap")
...
# Extract PCA embeddings
pca_embeddings <- Embeddings(mouse_1w_pca, reduction = "pca")
pca_df <- as.data.frame(pca_embeddings)

# Add metadata to the data frame (e.g., conditions)
pca_df$condition <- mouse_1w_pca@meta.data$orig.ident
