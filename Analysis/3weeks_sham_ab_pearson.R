...
# mouse_3w_pca_corr <- cor(mouse_3w_pca, method = "pearson")


# Assuming mouse_3w_pca is your Seurat object after running PCA

# Extract PCA embeddings
pca_embeddings_umap <- Embeddings(mouse_3w_umap, reduction = "umap")
...
# Extract PCA embeddings
pca_embeddings <- Embeddings(mouse_3w_pca, reduction = "pca")
pca_df <- as.data.frame(pca_embeddings)

# Add metadata to the data frame (e.g., conditions)
pca_df$condition <- mouse_3w_pca@meta.data$orig.ident
