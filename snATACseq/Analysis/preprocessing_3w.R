...
samples <- list(
  TP51 = list (h5_file = "D:/MultiomeSeq/TP5-1/outs/filtered_feature_bc_matrix.h5",
                frag_file = "D:/MultiomeSeq/TP5-1/outs/atac_fragments.tsv.gz",
                project = "3 Weeks - SHAM"),
  TP52 = list(h5_file = "D:/MultiomeSeq/Sample3-TP52A/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/Sample3-TP52A/outs/atac_fragments.tsv.gz",
               project= "3 Weeks - SHAM"),
  TP75 = list(h5_file = "D:/MultiomeSeq/Sample1-TP75B/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/Sample1-TP75B/outs/atac_fragments.tsv.gz",
               project= "3 Weeks - SHAM"),
  TP511 = list(h5_file = "D:/MultiomeSeq/Sample2-TP511B/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/Sample2-TP511B/outs/atac_fragments.tsv.gz",
               project= "3 Weeks - AB"),
  TP513 = list(h5_file = "D:/MultiomeSeq/TP51-3/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP51-3/outs/atac_fragments.tsv.gz",
               project= "3 Weeks - AB"),
  TP62 = list(h5_file = "D:/MultiomeSeq/Sample4-TP62A/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/Sample4-TP62A/outs/atac_fragments.tsv.gz",
               project= "3 Weeks - AB")
)
...
combined_plot <- a1 | a2 + plot_annotation(title = "ATAC-seq Quality Control Metrics at 3 Weeks") # Print the two plots
print(combined_plot)
...
SaveSeuratRds(combined_seurat, file = "D:/ATAC/combined_seurat_3w.Rds")
...
# Save seurat 
SaveSeuratRds(combined_seurat_filtered, file = "D:/ATAC/combined_seurat_filtered_3w.Rds")
