...
samples <- list(
  TP31 = list (h5_file = "D:/MultiomeSeq/TP3-1/outs/filtered_feature_bc_matrix.h5",
                frag_file = "D:/MultiomeSeq/TP3-1/outs/atac_fragments.tsv.gz",
                project = "1 Week - SHAM"),
  TP34 = list(h5_file = "D:/MultiomeSeq/TP3-4/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP3-4/outs/atac_fragments.tsv.gz",
               project= "1 Week - SHAM"),
  TP41 = list(h5_file = "D:/MultiomeSeq/TP4-1/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP4-1/outs/atac_fragments.tsv.gz",
               project= "1 Week - SHAM"),
  TP24 = list(h5_file = "D:/MultiomeSeq/TP2-4/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP2-4/outs/atac_fragments.tsv.gz",
               project= "1 Week - AB"),
  TP522 = list(h5_file = "D:/MultiomeSeq/TP52-2/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP52-2/outs/atac_fragments.tsv.gz",
               project= "1 Week - AB"),
  TP584 = list(h5_file = "D:/MultiomeSeq/TP58-4/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP58-4/outs/atac_fragments.tsv.gz",
               project= "1 Week - AB")
)
...
combined_plot <- a1 | a2 + plot_annotation(title = "ATAC-seq Quality Control Metrics at 1 Week") # Print the two plots
print(combined_plot)
...
SaveSeuratRds(combined_seurat, file = "D:/ATAC/combined_seurat_1w.Rds")
...
# Save seurat 
SaveSeuratRds(combined_seurat_filtered, file = "D:/ATAC/combined_seurat_filtered_1w.Rds")
