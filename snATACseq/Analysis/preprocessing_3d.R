...
samples <- list(
  TP91 = list (h5_file = "D:/MultiomeSeq/TP9-1/outs/filtered_feature_bc_matrix.h5",
                frag_file = "D:/MultiomeSeq/TP9-1/outs/atac_fragments.tsv.gz",
                project = "3 Days - SHAM"),
  TP95 = list(h5_file = "D:/MultiomeSeq/TP9-5/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP9-5/outs/atac_fragments.tsv.gz",
               project= "3 Days - SHAM"),
  TP115 = list(h5_file = "D:/MultiomeSeq/TP11-5/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP11-5/outs/atac_fragments.tsv.gz",
               project= "3 Days - SHAM"),
  TP92 = list(h5_file = "D:/MultiomeSeq/TP9-2/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP9-2/outs/atac_fragments.tsv.gz",
               project= "3 Days - AB"),
  TP102 = list(h5_file = "D:/MultiomeSeq/TP10-2/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP10-2/outs/atac_fragments.tsv.gz",
               project= "3 Days - AB"),
  TP111 = list(h5_file = "D:/MultiomeSeq/TP11-1A/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP11-1A/outs/atac_fragments.tsv.gz",
               project= "3 Days - AB")
)
...
combined_plot <- a1 | a2 + plot_annotation(title = "ATAC-seq Quality Control Metrics at 3 Days") # Print the two plots
print(combined_plot)
...
SaveSeuratRds(combined_seurat, file = "D:/ATAC/combined_seurat_3d.Rds")
...
# Save seurat 
SaveSeuratRds(combined_seurat_filtered, file = "D:/ATAC/combined_seurat_filtered_3d.Rds")
