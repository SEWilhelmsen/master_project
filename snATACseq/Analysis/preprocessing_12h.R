...
samples <- list(
  TP232 = list (h5_file = "D:/MultiomeSeq/TP23-2/outs/filtered_feature_bc_matrix.h5",
                frag_file = "D:/MultiomeSeq/TP23-2/outs/atac_fragments.tsv.gz",
                project = "12 Hours - SHAM"),
  TP234 = list(h5_file = "D:/MultiomeSeq/TP23-4/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP23-4/outs/atac_fragments.tsv.gz",
               project= "12 Hours - SHAM"),
  TP265 = list(h5_file = "D:/MultiomeSeq/TP26-5/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP26-5/outs/atac_fragments.tsv.gz",
               project= "12 Hours - SHAM"),
  TP231 = list(h5_file = "D:/MultiomeSeq/TP23-1/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP23-1/outs/atac_fragments.tsv.gz",
               project= "12 Hours - AB"),
  TP245 = list(h5_file = "D:/MultiomeSeq/TP24-5/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP24-5/outs/atac_fragments.tsv.gz",
               project= "12 Hours - AB"),
  TP264 = list(h5_file = "D:/MultiomeSeq/TP26-4/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP26-4/outs/atac_fragments.tsv.gz",
               project= "12 Hours - AB")
)
...
combined_plot <- a1 | a2 + plot_annotation(title = "ATAC-seq Quality Control Metrics at 12 Hours") # Print the two plots
print(combined_plot)
...
SaveSeuratRds(combined_seurat, file = "D:/ATAC/combined_seurat_12h.Rds")
...
# Save seurat 
SaveSeuratRds(combined_seurat_filtered, file = "D:/ATAC/combined_seurat_filtered_12h.Rds")
