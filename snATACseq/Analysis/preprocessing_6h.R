...
samples <- list(
  TP213 = list (h5_file = "D:/MultiomeSeq/TP21-3/outs/filtered_feature_bc_matrix.h5",
                frag_file = "D:/MultiomeSeq/TP21-3/outs/atac_fragments.tsv.gz",
                project = "6 Hours - SHAM"),
  TP221 = list(h5_file = "D:/MultiomeSeq/TP22-1/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP22-1/outs/atac_fragments.tsv.gz",
               project= "6 Hours - SHAM"),
  TP222 = list(h5_file = "D:/MultiomeSeq/TP22-2/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP22-2/outs/atac_fragments.tsv.gz",
               project= "6 Hours - SHAM"),
  TP192 = list(h5_file = "D:/MultiomeSeq/TP19-2/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP19-2/outs/atac_fragments.tsv.gz",
               project= "6 Hours - AB"),
  TP194 = list(h5_file = "D:/MultiomeSeq/TP19-4/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP19-4/outs/atac_fragments.tsv.gz",
               project= "6 Hours - AB"),
  TP223 = list(h5_file = "D:/MultiomeSeq/TP22-3/outs/filtered_feature_bc_matrix.h5",
               frag_file = "D:/MultiomeSeq/TP22-3/outs/atac_fragments.tsv.gz",
               project= "6 Hours - AB")
)
...
combined_plot <- a1 | a2 + plot_annotation(title = "ATAC-seq Quality Control Metrics at 6 Hours") # Print the two plots
print(combined_plot)
...
SaveSeuratRds(combined_seurat, file = "D:/ATAC/combined_seurat_6h.Rds")
...
# Save seurat 
SaveSeuratRds(combined_seurat_filtered, file = "D:/ATAC/combined_seurat_filtered_6h.Rds")
