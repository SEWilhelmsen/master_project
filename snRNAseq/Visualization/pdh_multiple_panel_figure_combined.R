# Create combined plot of the pyruvate dehydrogenase complex
# Silje Wilhelmsen
...
##############################################################################################
# Set margins
go_plot_pdh <- go_plot_pdh +
  theme(plot.margin = unit(c(1,1,2,1), "cm"))  # top, right, bottom, left margin
gene_plot_pdh <- gene_plot_pdh +
  theme(plot.margin = unit(c(1,1,2,5), "cm"))  # top, right, bottom, left margin

single_gene_plot_pdha1 <- single_gene_plot_pdha1 +
  theme(plot.margin = unit(c(1,1,2,1), "cm"))  # top, right, bottom, left margin
# single_gene_plot_dlat <- single_gene_plot_dlat +
#   theme(plot.margin = unit(c(1,1,2,1), "cm"))  # top, right, bottom, left margin
single_gene_plot_dld <- single_gene_plot_dld +
  theme(plot.margin = unit(c(1,1,2,1), "cm"))  # top, right, bottom, left margin

# single_gene_plot_pdhx <- single_gene_plot_pdhx +
#   theme(plot.margin = unit(c(1,15,2,1), "cm"))  # top, right, bottom, left margin
# single_gene_plot_pdhx <- single_gene_plot_pdhx +
#   theme(plot.margin = unit(c(1,1,2,1), "cm"))  # top, right, bottom, left margin
...
total_pdh_plot <- (go_plot_pdh | gene_plot_pdh) /
  (single_gene_plot_pdha1 | single_gene_plot_dld) 
