# Create combined plot of ketones
# Silje Wilhelmsen
...
file.edit("C:/Users/siljeew/Master_project/snRNAseq/Visualization/ketone_multiple_panel_figure.R")
...
total_ketone_plot <- (go_plot_hydroxybutyrate_dehydrogenase | go_plot_ketone_catabolism) /
  (gene_plot_bdh1 | gene_plot_oxct1) /
