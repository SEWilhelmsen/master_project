# Create a bar plot for go process grouped by stress status (not finished)
# 
# Silje Wilhelmsen
...
source("C:/Users/siljeew/Master_project/snRNAseq/Analysis/perform_anova_tukey_go_process_by_stress_status.R")
