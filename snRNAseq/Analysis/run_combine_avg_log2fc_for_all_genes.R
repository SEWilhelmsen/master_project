# Combine average log two fold change values for all timepoints into one file. 
# Silje Wilhelmsen
...
write.csv2(merged_data, file = file.path(output_dir_data, "mouse_vcm_all_genes_avg_log2fc.csv"), row.names = TRUE)


# Save the merged data to an RDS file for efficient storage and retrieval in R
saveRDS(merged_data, file = file.path(output_dir_data, "mouse_vcm_all_genes_avg_log2fc.Rds"))
